    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><a style={{ color: "blue" }} href="/test">Test - /test</a></li>
<li><a style={{ color: "blue" }} href="/objective">Objective - /objective</a></li>
<li><a style={{ color: "blue" }} href="/page-2">ExamplePage - /page-2</a></li>
<li><a style={{ color: "blue" }} href="/test-2">Test2 - /test-2</a></li>
          </ul>
